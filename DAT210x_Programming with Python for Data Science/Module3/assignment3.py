...
# 
# .. your code here ..
ax = fig.add_subplot(111,projection='3d',title='Area,Perimeter,Asymmetry')
ax.set_xlabel('area')
...
# 
# .. your code here ..
ay = fig.add_subplot(111,projection='3d',title='Width,Groove,Length')
ay.set_xlabel('width')
ay.set_ylabel('groove')
ay.set_zlabel('length')
ay.scatter(df.width,df.groove,df.length,c='green',marker='o')
