...
## since RandomizedPCA will be instead by PCA(svd_solver='randomized') in the future, so haven't import RandomizedPCA.
...
def do_RandomizedPCA(armadillo):
  ...
  randomized_pca.fit(armadillo)
  T = randomized_pca.transform(armadillo)
