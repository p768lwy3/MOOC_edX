...
##print(X.isnull().sum()); print(X.shape); exit()
print(X[pd.isnull(X).any(axis=1)])
...
# have the labels
labels = ['compactness','width','groove']
...
## Create an DecisionTreeClassifier named tree
## Set the max_depth to 9, and random_state to 2, but not altering any other setting
##
## .. my code here ..
