...
#
# .. your code here ..
X = pd.read_table('Datasets\dataset-har-PUC-Rio-ugulino.csv',sep=';',decimal = ',')
## print(X.head())
...
#
# .. your code here ..
## print(X.gender.unique()) ## 'Man', 'Woman'
...
## for man=1, woman=0, Score:  95.939
## after droping gender, Score:  96.158
