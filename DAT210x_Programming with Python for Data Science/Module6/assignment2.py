...
model = SVC(C=1, gamma=0.001, kernel='linear').fit(X_train, y_train)
...
# again.
## 0.961024498886 accuracy with the linear kernel
...
# again.
##  0.974944320713 accuracy with 'poly' kernel
...
## 0.982739420935 accuracy with RBF Kernel
## improved to 0.984409799555 by increasing C to 2
...
# Surprised?
## 0.854120267261, dropped by a little
