...
print(X.head()); print(X.isnull().sum()); print(X.dtypes) ## 2480 is missing
...
## print(X.isnull().sum()); print(X.shape)
...
## actually there is a bit problem with call or popen, and i have used graphviz.exe to print the img in Windows 10.
