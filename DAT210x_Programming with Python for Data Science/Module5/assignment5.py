...
# .. your code here ..
y = X.wheat_type
X = X.drop(['id','wheat_type'],axis=1) ## 'id' column is also dropped
...
#
# .. your code here ..
## print(X.isnull().sum()) ## compactness = 3, width = 1, groove = 4
for i in ['compactness','width','groove']:
...
#
# .. your code here ..
model = preprocessing.Normalizer().fit(X=X_train)
...
#
# .. your code here ..
knn = KNeighborsClassifier(n_neighbors=5).fit(pca_X_train, y_train)
