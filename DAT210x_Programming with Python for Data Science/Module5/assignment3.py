...
def doKMeans(data, clusters=0):
  ...
  labels = kmeans.fit_predict(pd.concat([data.TowerLon,data.TowerLat],axis=1))
...
## print(df.dtypes); print(df.head(5)); print(df.shape
...
print(unique_numbers); print(type(unique_numbers))
...
ax.scatter(user1.TowerLon,user1.TowerLat,c='b',marker='o',alpha=0.2)
