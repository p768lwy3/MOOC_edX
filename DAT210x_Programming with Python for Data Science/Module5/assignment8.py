...
## print(X.describe); print(X.head(5)); print(X.dtypes); print(X.shape); exit()
...
print('Type: ',type(y_train),type(X_train))
...
#
# .. your code here ..
print('the actual 2014 WhiteMale life expectancy is ', X.WhiteMale[(X.Year==2014)].values[0])
...
print('the actual 2014 BlackFemale life expectancy is ', X.BlackFemale[(X.Year==2014)].values[0])
