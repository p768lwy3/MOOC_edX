...
## print(X.head(4)); print(X.dtypes); print(X.shape); print(X.isnull().sum()); exit()
...
X_train, X_test, y_train, y_test = train_test_split(x1, x2, test_size = 0.3, random_state = 7)
...
#
# .. your code here ..
x2 = X[['Room.Board', 'Enroll']]
X_train, X_test, y_train, y_test = train_test_split(x2, x1, test_size = 0.3, random_state = 7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
