...
## len of df does not equal to the len of label(698, 697), so remove the first row of df.
## print(df.head(7))
...
if Test_PCA:
  ...
  #
  # .. your code here ..
  iso = Isomap(n_neighbors=6,n_components=2).fit(data_train)
...
#
# .. your code here ..
model = KNeighborsClassifier(n_neighbors=5).fit(data_train, label_train)
